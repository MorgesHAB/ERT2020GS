...
void GuiWindow::theme_change_clicked() {
    //((int)current_theme_ == theme_count - 1) ? (current_theme_ = GREEN_ON_BLACK) : (current_theme_ = (current_theme_ + 1));
    ...
    } else if (white_theme_ % THEME_COUNT == 2) {
        setStyleSheet(QLatin1String("background-color: rgb(30, 30, 30);\n"
