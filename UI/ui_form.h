/********************************************************************************
** Form generated from reading UI file 'press_altDi2704.ui'
**
...
#ifndef PRESS_ALTDI2704_H
#define PRESS_ALTDI2704_H
...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        gridLayout->addWidget(gps_box, 3, 0, 2, 2);
        ...
        gridLayout->addWidget(euler_box, 5, 2, 1, 1);
        ...
        gridLayout->addWidget(avionics_box, 3, 2, 2, 1);
        ...
        gridLayout->addWidget(logo, 5, 3, 1, 1);
        ...
        gridLayout->addWidget(accel_box, 3, 3, 2, 1);
        ...
        gridLayout->addWidget(com_box, 2, 1, 1, 3);
