/********************************************************************************
** Form generated from reading UI file 'press_altSs2971.ui'
**
...
#ifndef PRESS_ALTSS2971_H
#define PRESS_ALTSS2971_H
...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        gridLayout_10->addWidget(gps_box, 2, 0, 1, 2);
        ...
        gridLayout_10->addWidget(avionics_box, 2, 2, 1, 3);
        ...
        gridLayout_10->addWidget(groupBox, 3, 0, 1, 1);
        ...
        gridLayout_10->addWidget(logo, 3, 5, 1, 1);
        ...
        gridLayout_10->addWidget(widget, 0, 0, 1, 6);
        ...
        gridLayout_10->addWidget(euler_box, 3, 4, 1, 1);
        ...
        gridLayout_10->addWidget(com_box, 1, 1, 1, 5);
        ...
        gridLayout_10->addWidget(groupBox1, 3, 1, 1, 3);
