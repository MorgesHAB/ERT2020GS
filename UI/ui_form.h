/********************************************************************************
** Form generated from reading UI file 'press_altab2628.ui'
**
...
#ifndef PRESS_ALTAB2628_H
#define PRESS_ALTAB2628_H
...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        gridLayout_10->addWidget(gse_state_box, 1, 4, 2, 1);
        ...
        gridLayout_5->addWidget(request_rssi, 2, 4, 1, 1);

        dbm_label = new QLabel(upper_widget);
        dbm_label->setObjectName(QStringLiteral("dbm_label"));

        gridLayout_5->addWidget(dbm_label, 2, 6, 1, 1);
        ...
        gridLayout_5->addWidget(time_panel, 0, 4, 1, 3);

        rssi_value_panel = new QLabel(upper_widget);
        rssi_value_panel->setObjectName(QStringLiteral("rssi_value_panel"));

        gridLayout_5->addWidget(rssi_value_panel, 2, 5, 1, 1);


        gridLayout_10->addWidget(upper_widget, 1, 6, 1, 1);
        ...
        gridLayout_10->addWidget(com_box, 3, 0, 2, 3);
        ...
        gridLayout_10->addWidget(gps_box, 3, 3, 2, 2);
        ...
        gridLayout_10->addWidget(groupBox, 2, 6, 1, 1);

        logo_setup_widget = new QTabWidget(Form);
        ...
        gridLayout_10->addWidget(logo_setup_widget, 6, 6, 1, 1);
        ...
        gridLayout_10->addWidget(avionics_box, 6, 3, 1, 2);

        gse_control_box = new QGroupBox(Form);
        ...
        gridLayout_10->addWidget(gse_control_box, 3, 6, 1, 1);
        ...
        gridLayout_10->addWidget(groupBox1, 4, 6, 1, 1);
        ...
        gridLayout_10->addWidget(euler_box, 1, 0, 1, 1);
        ...
        gridLayout_10->addWidget(accel_box, 2, 0, 1, 1);
        ...
        gridLayout_11->addWidget(filling_label_av, 5, 0, 1, 1);
        ...
        gridLayout_11->addWidget(filling_av_ok_panel, 5, 1, 1, 1);
        ...
        gridLayout_10->addWidget(av_states_box, 1, 1, 2, 3);
        ...
        ignition_frame->setMinimumSize(QSize(0, 0));
        ignition_frame->setMaximumSize(QSize(16777215, 35));
        ...
        gridLayout_10->addWidget(ignition_box, 6, 0, 1, 3);


        retranslateUi(Form);

        logo_setup_widget->setCurrentIndex(0);
